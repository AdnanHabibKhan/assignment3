...
<form action="" method="post">
  <div class="container">
    ...
    <label for="email"><b>First Name</b></label> <input type="text" placeholder="Enter Email" name="firstname" required><br>

    <label for="psw"><b>Last Name</b></label>
     <input type="text" placeholder="Enter Email" name="lastname" required><br>
<label for="psw-repeat"><b>Email  &nbsp   &nbsp &nbsp   </b></label>
     <input type="text" placeholder="Enter Email" name="email" required><br>
    

<label for="psw-repeat"><b>Gender  &nbsp   &nbsp </b></label>
    <input type="text" placeholder="Enter Email" name="gender" required><br>
<label for="psw-repeat"><b>Birthday  &nbsp   &nbsp </b></label>
        <input type="text" placeholder="Enter Email" name="dob" required><br>
